...
/* BackendBundle:Default:usuarios.html.twig */
class __TwigTemplate_315342339e7b359c56e630507311c8e172905818aca5229a36fb5a4ae3d5b2af extends Twig_Template
{
...
";
     ...
     <!-- Page heading -->
      <div class=\"page-head\">
        ...
        if ($this->env->getExtension('security')->isGranted("ROLE_SUPER_ADMIN")) {
            // line 46
            echo "          <a href=\"#new\" class=\"btn btn-info pull-right\" style=\"color: white; margin-left: 5px;\">Crear usuario</a>
          ";
        }
        // line 48
        echo "        </div>
  ...
  ";
        // line 71
        $this->env->loadTemplate("BackendBundle:Usuario:index.html.twig")->display($context);
        // line 72
        echo "
  ";
        // line 73
        $this->env->loadTemplate("BackendBundle:Usuario:show.html.twig")->display($context);
        // line 74
        echo "
";
    }
...
<script src=\"";
        // line 100
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/backend/js/app_usuario.js"), "html", null, true);
        echo "\"></script> 
<script src=\"";
        // line 101
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/backend/js/app_usuario.js"), "html", null, true);
...
\$(document).ready(function() {
    window.api = {
      url: '";
        // line 108
        echo $this->env->getExtension('routing')->getPath("api_1_get_usuarios");
        echo "',
      accion: {
          guardar: false,
          eliminar: false,
    ...
    \$(\".loader\").fadeIn();
    window.routers.app = new Usuarios.Routers.App();
    window.collections.usuarios = new Usuarios.Collections.Usuarios();
    window.collections.usuarios.url=window.api.url;
...
";
    ...
    {
        return "BackendBundle:Default:usuarios.html.twig";
    }
