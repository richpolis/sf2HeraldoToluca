...
/* BackendBundle:UsuarioApi:index.html.twig */
class __TwigTemplate_396a67e68375c5f48ef64e96fa8fec209c0a3be7a02253966b4eb89cad809729 extends Twig_Template
{
...
<script type=\"text/template\" id=\"item_table_template\">
    ...
    <td>
        {% if imagen %}
            <img src=\"{{webPath}}\" style=\"max-width: 100px;\"/>
        {% else  %}
            sin imagen 
        {% endif %}
    </td>
