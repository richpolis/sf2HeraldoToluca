...
/* GaleriasBundle:GaleriasApi:index.html.twig */
class __TwigTemplate_cd49d4ce02c209b4a16687ec1d4661b3d86acb72978c03a831878176b2aba3d5 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
        <div class=\"widget\">
            <div class=\"widget-head\">
                <div class=\"pull-left\">Registro de Categorias</div>
...
<script type=\"text/template\" id=\"item_table_template\">
    <td>{{ id }}</td>
    <td><img src=\"{{webPathThumbnail}}\" style=\"max-width: 60px;\"/></td>
    <td>{{ stringTipo }}</td>
